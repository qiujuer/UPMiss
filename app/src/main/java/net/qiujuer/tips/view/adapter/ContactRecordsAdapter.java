...
import net.qiujuer.tips.factory.presenter.ContactRecordsPresenter;
...
public class ContactRecordsAdapter extends RecyclerView.Adapter<RecordsViewHolder> implements RecordsView {
    ...
    public ContactRecordsAdapter(UUID contactId, RecyclerView view, View nullView, AdapterSelectCallback callback) {
        mDataSet = new ArrayList<RecordViewModel>();
        mRecycler = view;
        mNullView = nullView;
        mCallback = callback;
        mPresenter = new ContactRecordsPresenter(contactId, this);
